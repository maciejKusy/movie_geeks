...
def main():
    ...
    # user1.rate_film('Horror 9 (1995)', 10)
    # user1.rate_film('Horror 2 (1987)', 8)
    # user1.rate_film('Horror 8 (1995)', 7)
    # user2.rate_film('Horror 13 (1995)', 10)
    # print(RecommendationManager.create_list_of_suggested_films_for_user(user2))
